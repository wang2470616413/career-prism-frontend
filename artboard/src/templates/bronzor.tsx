...
const Experience = () => {
  ...
  return (
    <Section<Experience> section={section} urlKey="url" summaryKey="summary">
      {(item) => (
        <div className="group relative flex items-start justify-between rounded-md p-2 -m-2 transition-all duration-200 hover:ring-2 hover:ring-red-500">
          ...
          {/* 优化图标 - 悬停时显示 */}
          <div className="absolute bottom-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 cursor-pointer hover:scale-110">
            <span className="text-3xl transition-transform duration-200 hover:scale-[30]" title="优化">✨</span>
          </div>
        </div>
      )}
    </Section>
